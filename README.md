...
**Before being able to use Libsnout for facetracking or training models, one ***must*** configure it. See [CONFIGURING.md](CONFIGURING.md) for information on how to do so.**
